...
Route::get('/blogs/trash','BlogsController@trash')->name('blog.trash');
...
Route::get('/blogs/{id}/edit','BlogsController@edit')->name('blog.edit');
Route::patch('/blogs/{id}/update','BlogsController@update')->name('blog.update');
Route::delete('/blogs/{id}/delete','BlogsController@delete')->name('blog.delete');
